...
# family , you can use '*'
usernames["wikipedia"]["de"] = "CountCountBot"
...
db_hostname_format = "{0}.web.db.svc.eqiad.wmflabs"
db_name_format = "{0}_p"
...
cosmetic_changes_deny_script = ["category_redirect", "cosmetic_changes", "newitem", "touch"]
